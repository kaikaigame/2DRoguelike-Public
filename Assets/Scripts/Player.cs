...
public class Player : MovingObject
{
    ...
    //Number of points to add to player food points
    //when picking up a food object.
    public int pointsPerFood = 10;

    //Number of points to add to player food points
    //when picking up a soda object.
    public int pointsPerSoda = 20;

    //How much damage a player does
    //to a wall when chopping it.
    ...
    {
        //When Player object is disabled, store the current local food total
        //in the GameManager so it can be re-loaded in next level.
    ...
    private void Update()
    {
        ...
        //Check if we are running on iOS, Android, Windows Phone 8 or Unity iPhone
            ...
            if (Input.touchCount > 0)
            {
                ...
                //If the touch phase is not Began, and instead is equal to Ended and the x 
                //of touchOrigin is greater or equal to zero:
                else if (myTouch.phase == TouchPhase.Ended && touchOrigin.x >= 0)
                {
                    ...
                    //and end of the touch on the x axis.
                    float x = touchEnd.x - touchOrigin.x;

                    //Calculate the difference between the beginning 
                    //and end of the touch on the y axis.
                    ...
                    //Check if the difference along the x axis is greater 
                    //than the difference along the y axis.
        ...
        if (horizontal != 0 || vertical != 0)
        {
            ...
            //since that is what Player may interact with 
    ...
    //AttemptMove overrides the AttemptMove 
    //function in the base class MovingObject
    //AttemptMove takes a generic parameter T 
    //which for Player will be of the type Wall, 
    ...
    protected override void AttemptMove<T>(int xDir, int yDir)
    {
        ...
        {
            //Call RandomizeSfx of SoundManager to play the move sound, 
            //passing in two audio clips to choose from.
    ...
    //It takes a generic parameter T which in the case of Player is 
    //a Wall which the player can attack and destroy.
    protected override void OnCantMove<T>(T component)
    {
        ...
        //in order to play the player's attack animation.
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if (other.tag == "Food")
        {
            ...
            //Update foodText to represent current total and 
            //notify player that they gained points
            foodText.text = "+" + pointsPerFood + " Food: " + food;

            //Call the RandomizeSfx function of SoundManager and pass 
            //in two eating sounds to choose between to play the eating sound effect.
        ...
        else if (other.tag == "Soda")
        {
            ...
            //Update foodText to represent current total 
            //and notify player that they gained points
            foodText.text = "+" + pointsPerSoda + " Food: " + food;

            //Call the RandomizeSfx function of SoundManager 
            //and pass in two drinking sounds to choose 
            //between to play the drinking sound effect.
    ...
    {
        //Load the last scene loaded, in this case Main, 
        //the only scene in the game.
    ...
    {
        //Set the trigger for the player animator 
        //to transition to the playerHit animation.
    ...
    //CheckIfGameOver checks if the player is out 
    //of food points and if so, ends the game.
    private void CheckIfGameOver()
    {
        //Check if food point total is less than or equal to zero.
        if (food <= 0)
        {
            //Call the PlaySingle function of SoundManager and 
            //pass it the gameOverSound as the audio clip to play.
