    ...
    public class BoardManager : MonoBehaviour
    {
        ...
        void InitialiseList()
        {
            ...
            for (int x = 1; x < columns - 1; x++)
            {
                ...
                {
                    //At each index add a new Vector3 to our list 
                    //with the x and y coordinates of that position.
        ...
        void BoardSetup()
        {
            ...
            for (int x = -1; x < columns + 1; x++)
            {
                ...
                for (int y = -1; y < rows + 1; y++)
                {
                    //Choose a random tile from our array of floor 
                    //tile prefabs and prepare to instantiate it.
                    ...
                    //chosen for toInstantiate at the Vector3 corresponding 
        ...
        //LayoutObjectAtRandom accepts an array of game objects to 
        //choose from along with a minimum and maximum range 
        //for the number of objects to create.
        void LayoutObjectAtRandom(GameObject[] tileArray, int minimum, int maximum)
        {
            ...
            //Instantiate objects until the randomly chosen 
            //limit objectCount is reached
            for (int i = 0; i < objectCount; i++)
            {
                //Choose a position for randomPosition by 
                //getting a random position from our list of 
                //available Vector3s stored in gridPosition
                Vector3 randomPosition = RandomPosition();

                //Choose a random tile from tileArray 
                //and assign it to tileChoice
        ...
        //SetupScene initializes our level and calls the 
        //previous functions to lay out the game board
        public void SetupScene(int level)
        {
            ...
            //Instantiate a random number of wall tiles based 
            //on minimum and maximum, at randomized positions.
            LayoutObjectAtRandom(wallTiles, wallCount.minimum, wallCount.maximum);

            //Instantiate a random number of food tiles based 
            //on minimum and maximum, at randomized positions.
            LayoutObjectAtRandom(foodTiles, foodCount.minimum, foodCount.maximum);

            //Determine number of enemies based on current level 
            //number, based on a logarithmic progression
            int enemyCount = (int)Mathf.Log(level, 2f);

            //Instantiate a random number of enemies based on 
